...
3. `/Users/ujeonghyeon/Desktop/dev/myDev/ao-skills/skills/record-android-review-failure/references/failure-cases.md`를 전부 읽는다.
...
```bash
cp -R /Users/ujeonghyeon/Desktop/dev/myDev/ao-skills/skills/record-android-review-failure ~/.Codex/skills/
```
