...
ctx="지식 후보가 ${sessions}개 세션 분량 쌓였습니다. 시간 날 때 /knowledge-loop 로 승격 리뷰를 권장합니다(마지막 안내 후 3일+ 경과). 후보 파일: ~/.claude/knowledge/pending.md"
