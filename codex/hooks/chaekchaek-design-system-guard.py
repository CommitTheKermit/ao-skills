...
PROJECT_ROOT = Path("/Users/ujeonghyeon/Desktop/dev/myDev/2026-chaekchaek/android")
APPROVED_COLORS = {
...
def record_usage() -> None:
    subprocess.run(
        [
            "python3",
            str(Path.home() / ".agents/skills/usage-stats/scripts/usage_stats.py"),
            "record",
            "hook",
            "chaekchaek-design-system-guard",
        ],
...
def is_chaekchaek_path(value) -> bool:
    try:
